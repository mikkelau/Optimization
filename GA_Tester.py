...
from optimizer_RealEncodedGA import RealEncodedGAOptimizer 
...
for runNum in range(numRuns):
    ...
    optimizer = RealEncodedGAOptimizer(function, upper_bounds, lower_bounds, max_iters, plot_generations=True, num_pops=33)
